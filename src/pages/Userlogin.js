    ...
    return (
        <div >
            ...
            <div className="contant">
                <h1 style={{ margin: " 10px 150px", color: "red", background: "black" }}>User Login</h1>
                <div className="data">
                    <h3>user name</h3>
                ...
                {
                    log.map((log) =>
                        (data == log.name && password == log.password) ? (navigate('/upload?user=' + { data })) : <p>Login your account <span style={{ color: "red" }} > with correct it</span></p>)
                }
                </div>
            </div>
        </div>
